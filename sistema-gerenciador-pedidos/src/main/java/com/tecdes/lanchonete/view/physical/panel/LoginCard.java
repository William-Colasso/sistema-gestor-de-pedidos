...
public class LoginCard extends LayeredOverlayCard {
    ...
    public LoginCard(DeckFrame cardLayoutable, String cardName,GerenteController gerenteController, 
        ...
        send.addActionListener((ActionEvent e) -> {
            ...
            else JOptionPane.showMessageDialog(this, "Erro: Login e/ou senha incorreto(s)", "Erro ao fazer login!", JOptionPane.PLAIN_MESSAGE);
        });
    ...
    @Override
    public DeckFrame getCardLayoutbleFrame() {
